...
urlpatterns = [
    ...
    path('MechSignUp/',views.MechSignUp,name="MechSignUp"),
    path('work_request/',views.work_request,name="work_request"),
    path('customer_view_mechanic/',views.user_view_mechanic,name="user_view_mechanic"),
    path('customer_view_status/',views.customer_view_status,name="customer_view_status"),
    path('MechHome/',views.Mch_Home,name="MechHome"),
    path('Mech_Requests/',views.Mech_Requests,name="Mech_Requests"),
    path('statusAction/',views.statusAction,name="statusAction"),
    path('Mech_Requests_Approved/',views.Mech_Requests_Approved,name="Mech_Requests_Approved"),
    path('customer_join_status/',views.customer_join_status,name="customer_join_status"),
]
